...
from awscli.vendored.s3transfer.compat import SOCKET_ERROR
from awscli.vendored.s3transfer.compat import seekable
from awscli.vendored.s3transfer.exceptions import RetriesExceededError
from awscli.vendored.s3transfer.futures import IN_MEMORY_DOWNLOAD_TAG
from awscli.vendored.s3transfer.utils import random_file_extension
from awscli.vendored.s3transfer.utils import get_callbacks
from awscli.vendored.s3transfer.utils import invoke_progress_callbacks
from awscli.vendored.s3transfer.utils import calculate_range_parameter
from awscli.vendored.s3transfer.utils import FunctionContainer
from awscli.vendored.s3transfer.utils import CountCallbackInvoker
from awscli.vendored.s3transfer.utils import StreamReaderProgress
from awscli.vendored.s3transfer.utils import DeferredOpenFile
from awscli.vendored.s3transfer.tasks import Task
from awscli.vendored.s3transfer.tasks import SubmissionTask
