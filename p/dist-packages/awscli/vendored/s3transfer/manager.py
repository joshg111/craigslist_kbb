...
from awscli.vendored.s3transfer.utils import get_callbacks
from awscli.vendored.s3transfer.utils import disable_upload_callbacks
from awscli.vendored.s3transfer.utils import enable_upload_callbacks
from awscli.vendored.s3transfer.utils import CallArgs
from awscli.vendored.s3transfer.utils import OSUtils
from awscli.vendored.s3transfer.utils import TaskSemaphore
from awscli.vendored.s3transfer.utils import SlidingWindowSemaphore
from awscli.vendored.s3transfer.exceptions import CancelledError
from awscli.vendored.s3transfer.exceptions import FatalError
from awscli.vendored.s3transfer.futures import IN_MEMORY_DOWNLOAD_TAG
from awscli.vendored.s3transfer.futures import IN_MEMORY_UPLOAD_TAG
from awscli.vendored.s3transfer.futures import BoundedExecutor
from awscli.vendored.s3transfer.futures import TransferFuture
from awscli.vendored.s3transfer.futures import TransferMeta
from awscli.vendored.s3transfer.futures import TransferCoordinator
from awscli.vendored.s3transfer.download import DownloadSubmissionTask
from awscli.vendored.s3transfer.upload import UploadSubmissionTask
from awscli.vendored.s3transfer.copies import CopySubmissionTask
from awscli.vendored.s3transfer.delete import DeleteSubmissionTask
