...
from .curves import NIST256p, NIST384p, NIST521p, SECP256k1
...
class ECDSA(unittest.TestCase):
    ...
    def test_lengths(self):
        ...
        if BENCH:
            print_()
        for curve in (NIST256p, NIST384p, NIST521p):
            start = time.time()
    ...
    def test_privkey_creation(self):
        ...
        self.assertEqual(priv1.baselen, NIST256p.baselen)

        priv1 = SigningKey.generate(entropy=not_much_entropy)
        self.assertEqual(priv1.baselen, NIST256p.baselen)
        priv2 = SigningKey.generate(entropy=not_much_entropy)
        self.assertEqual(priv2.baselen, NIST256p.baselen)
    ...
    def test_privkey_strings(self):
        ...
        self.assertEqual(len(s1), NIST256p.baselen)
    ...
    def test_signature_strings(self):
        ...
        self.assertEqual(len(sig), NIST256p.signature_length)
        ...
        self.assertEqual(len(sig[0]), NIST256p.baselen)
        self.assertEqual(len(sig[1]), NIST256p.baselen)
