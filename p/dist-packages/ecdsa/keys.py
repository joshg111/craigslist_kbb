...
from . import der
from . import rfc6979
from .curves import NIST256p, find_curve
...
class VerifyingKey:
    ...
    @classmethod
    def from_public_point(klass, point, curve=NIST256p, hashfunc=sha1):
    ...
    @classmethod
    def from_string(klass, string, curve=NIST256p, hashfunc=sha1,
                    validate_point=True):
        order = curve.order
...
class SigningKey:
    ...
    @classmethod
    def generate(klass, curve=NIST256p, entropy=None, hashfunc=sha1):
    ...
    @classmethod
    def from_secret_exponent(klass, secexp, curve=NIST256p, hashfunc=sha1):
        self = klass(_error__please_use_generate=True)
        self.curve = curve
        self.default_hashfunc = hashfunc
